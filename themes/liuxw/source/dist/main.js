    ...
    "jSg4": [function(require, module, exports) {
        ! function(e) {
            ...
            e(".nav-item-search").click(function() {
                var n;
                a || (a = !0, o.addClass("on"), n = function() { e(".local-search-input").focus() }, setTimeout(function() { a = !1, n && n() }, 200))
            }), e(document).mouseup(function(a) {
                var n = e(".local-search");
                n.is(a.target) || 0 !== n.has(a.target).length || o.removeClass("on")
            }), e(".local-search").size() && e.getScript("/thinkerlxw/js/search.js", function() { searchFunc("/thinkerlxw/search.xml", "local-search-input", "local-search-result") });
            var n;
    ...
    "BNiz": [function(require, module, exports) {
        ...
        var c = function() {
            ...
            if (e && 0 !== e.length) {
                ...
                "" === o || /^(http:|https:)?\/\//.test(o) || (o = window.location.origin + o), e.forEach(function(e) { e.onclick = function(s) { r(e.getAttribute("data-type"), { sUrl: t, sPic: o, sTitle: c, sDesc: c }) } }), document.querySelector("#mask").onclick = s, document.querySelector(".modal-close").onclick = s
            }
        };
        c();
    }, {}],
